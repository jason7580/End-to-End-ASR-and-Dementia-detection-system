...
from core.asr import ASR, Encoder_CDR
...
#                 self.optimizer.load_opt_state_dict(ckpt['optimizer'])
    ...
    def set_model(self):
        ...
        # Model
        self.model = Encoder_CDR(self.feat_dim, **
...
#                     self.validate()
                ...
                self.timer.set()
                if (self.step2 % 1000 == 0) and self.step2 >= 3000:
                    self.save_checkpoint(f'latest{int(self.step2 / 1000)}kCDR_1VGG_4LSTM.pth', 'loss',
                             loss, show_msg=False)
        ...
        self.save_checkpoint('latest14kCDR_1VGG_4LSTM.pth', 'loss',
                             loss, show_msg=False)
        print(self.step2)
        self.log.close()
