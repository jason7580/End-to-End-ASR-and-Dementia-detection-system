...
#                 self.optimizer.load_opt_state_dict(ckpt['optimizer'])
    ...
    def set_model(self):
        ...
        nonfreeze_keys = ['fc.weight', 'fc.bias', 'encoder.layers.0.extractor.0.weight', 'encoder.layers.0.extractor.0.bias', 'encoder.layers.4.layer.weight_ih_l0_reverse', 'encoder.layers.4.layer.weight_hh_l0_reverse', 'encoder.layers.4.layer.bias_ih_l0_reverse', 'encoder.layers.4.layer.bias_hh_l0_reverse']
#         nonfreeze_keys = ['fc.weight', 'fc.bias', 'encoder.layers.4.layer.weight_ih_l0_reverse', 'encoder.layers.4.layer.weight_hh_l0_reverse', 'encoder.layers.4.layer.bias_ih_l0_reverse', 'encoder.layers.4.layer.bias_hh_l0_reverse']
        # Model
...
#                     self.validate()
                ...
                self.timer.set()
                if (self.step2 % 1000 == 0) and self.step2 >= 6000:
                    self.save_checkpoint(f'latest{int(self.step2 / 1000)}knew_oldASR_1VGG_4LSTM.pth', 'loss',
                             loss, show_msg=False)
        ...
        self.save_checkpoint('latest14knew_oldASR_1VGG_4LSTM.pth', 'loss',
                             loss, show_msg=False)
        print(self.step2)
        self.log.close()
