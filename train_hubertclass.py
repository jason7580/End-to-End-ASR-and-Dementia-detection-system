...
from core.hubert import Hubert_Classifier
from core.optim import Optimizer
from core.data import load_hubert_dataset
...
#                 self.optimizer.load_opt_state_dict(ckpt['optimizer'])
    ...
    def load_data(self):
        ...
        self.tr_set, self.dv_set= \
            load_hubert_dataset(self.paras.njobs, self.paras.gpu, self.paras.pin_memory,
    ...
    def exec(self):
        ...
        while n_epochs < total_epochs:
            ...
            for data in self.tr_set:
                ...
                with torch.no_grad():
                    outputs = self.hubert(feat[0])
                    last_hidden_state = outputs.last_hidden_state
                output = self.model(last_hidden_state)
#                 print(output.shape)
#                 print(output)
#                 print('txt:',txt)
...
#                     self.validate()
            ...
            print(total_loss, '\n')
            n_epochs += 1
        self.save_checkpoint('hubert9k.pth', 'loss',
                             loss, show_msg=False)
        print(self.step2)
        self.log.close()
...
#                 print(torch.isnan(last_hidden_state).any())
