...
OFFICIAL_TXT_SRC = ['LutranscriptForLM.txt']
...
class LuDataset(Dataset):
    def __init__(self, path, split, tokenizer, bucket_size, ascending=False):
        # Setup
        print("[LuDataset] path: {}, split: {}".format(path, split))
        self.path = path
        ...
        for s in split:
            ...
            print("LuDataset {} found wav data: {}".format(s, len(split_list)))
