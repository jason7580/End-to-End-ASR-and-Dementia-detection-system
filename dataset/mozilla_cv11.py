...
def read_text(file):
    ...
    src_file = "/mnt/usb/jason3/cv-corpus-11.0-2022-09-21/zh-TW/cv11transcriptLu.txt"
...
class Mozillacv11Dataset(Dataset):
    def __init__(self, path, split, tokenizer, bucket_size, ascending=False):
        # Setup
        print("[Mozillacv11Dataset] path: {}, split: {}".format(path, split))
        self.path = path
